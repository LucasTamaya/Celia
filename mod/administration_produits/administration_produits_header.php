...
if ($id_produit > 0)
    ...
    $html .= '       <h1 class="text-center text-2xl font-semibold my-5">Ajouter un nouveau produit</h1>';
...
$html .= '           <div>';
$html .= '               <label>Image du produit</label>';
...
// Bouton Enregistrer
$html .= '           <button class="text-white p-2 bg-blue-900 rounded">Ajouter le produit</button>';
